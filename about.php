...
<body class="bg-light">
  ...
  <div class="my-5 px-4">
    ...
    At LEOSHLI, we redefine luxury and hospitality in the vibrant city of Fatorda, Goa. <br>Our hotel is a sanctuary where comfort meets elegance,<br> offering a blend of modern amenities and authentic Goan warmth. <br>Whether you’re here for business or leisure, we’re dedicated to making your stay extraordinary.
    </p>
  </div>
  ...
  <div class="container">
    <div class="row justify-content-between align-items-center">
      <div class="col-lg-6 col-md-5 mb-4 order-lg-1 order-md-1 order-2">
        ...
        <ul>
        <li><strong>Prime Location:</strong> Situated in the heart of Goa, LEOSHLI provides easy access to local attractions, beaches, and cultural spots.</li>
